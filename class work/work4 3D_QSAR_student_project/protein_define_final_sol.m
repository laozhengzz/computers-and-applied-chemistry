...
for i=1:size_protein_atom(1,1)
    ...
    elseif (strncmp(AtomName{i,1}, 'CA', 2)==1) && (strncmp(resName{i,1}, 'CA', 2)==1)
        protein_name(i,1)=CAA;
        protein_name(i,2)=CAA;
        protein_atom_radius(i)=1.2;
        protein_atom_hb(i)=N_A;
        protein_acceptor_hb_angle(i)=0;
        protein_donor_hb_angle(i)=0;
    ...
    elseif (strncmp(AtomName{i,1}, 'K', 1)==1) && (strncmp(resName{i,1}, 'K', 1)==1)
        protein_name(i,1)=K;
        protein_name(i,2)=K;
        protein_atom_radius(i)=1.2;
        protein_atom_hb(i)=N_A;
    ...
    elseif (strncmp(AtomName{i,1}, 'MG', 1)==1) && (strncmp(resName{i,1}, 'MG', 1)==1)
        protein_name(i,1)=MG;
        protein_name(i,2)=MG;
        protein_atom_radius(i)=1.2;
        protein_atom_hb(i)=N_A;
        ...
        protein_atom_charge(i)=2;
        protein_backbone(i)=0;    
    elseif (strncmp(AtomName{i,1}, 'AL', 1)==1) && (strncmp(resName{i,1}, 'AL', 1)==1)
        protein_name(i,1)=AL;
        protein_name(i,2)=AL;
        protein_atom_radius(i)=1.2;
        protein_atom_hb(i)=N_A;
        protein_acceptor_hb_angle(i)=0;
        protein_donor_hb_angle(i)=0;
        protein_atom_charge(i)=3;
        protein_backbone(i)=0;    
    elseif (strncmp(AtomName{i,1}, 'MN', 1)==1) && (strncmp(resName{i,1}, 'MN', 1)==1)
        protein_name(i,1)=MN;
        protein_name(i,2)=MN;
        protein_atom_radius(i)=1.2;
        protein_atom_hb(i)=N_A;
    ...
    elseif (strncmp(AtomName{i,1}, 'FE', 1)==1) && (strncmp(resName{i,1}, 'FE', 1)==1)
        protein_name(i,1)=FE;
        protein_name(i,2)=FE;
        protein_atom_radius(i)=1.2;
        protein_atom_hb(i)=N_A;
    ...
    elseif (strncmp(AtomName{i,1}, 'CO', 1)==1) && (strncmp(resName{i,1}, 'CO', 1)==1)
        protein_name(i,1)=CO;
        protein_name(i,2)=CO;
        protein_atom_radius(i)=1.2;
        protein_atom_hb(i)=N_A;
    ...
    elseif (strncmp(AtomName{i,1}, 'NI', 1)==1) && (strncmp(resName{i,1}, 'NI', 1)==1)
        protein_name(i,1)=NI;
        protein_name(i,2)=NI;
        protein_atom_radius(i)=1.2;
        protein_atom_hb(i)=N_A;
    ...
    elseif (strncmp(AtomName{i,1}, 'CU', 1)==1) && (strncmp(resName{i,1}, 'CU', 1)==1)
        protein_name(i,1)=CU;
        protein_name(i,2)=CU;
        protein_atom_radius(i)=1.2;
        protein_atom_hb(i)=N_A;
